...
//        $ClientAuth->SetAuthData(array('user_name' => $userInfo['user_name'], 'user_name' => $userInfo['user_name'], 'user_id' => $userInfo['id'], 'group' => 0));
        ...
        // TODO jieqiangtest 修改用户组
        $ClientAuth->SetAuthData(array('user_name' => $userInfo['user_name'], 'user_id' => $userInfo['id'], 'user_real_name' => $userInfo['user_real_name'], 'user_group' => $userInfo['user_group'], 'group' => $userInfo['user_group']));
        return true;
    }
    ...
    function IsLogin()
    {
        ...
        // var_dump('TODO jieqiangtest $ClientAuth->GetAuthData()==',$ClientAuth->GetAuthData());exit;
